...
public class CleanupDatabase : IHostedService
    {
    private readonly ILogger<CleanupDatabase> _logger;
    private readonly IConfiguration _env;
    private readonly PeriodicTimer _timer;
    private readonly IMongoCollection<Movie> _collection;
    public CleanupDatabase(IConfiguration env, ILogger<CleanupDatabase> logger, IMongoClient mongoClient)
    {
        _logger = logger;
        _env = env;
